...
$(function() {
	...
	$('.welcome__stuff-box').on('click', function() {
		$('.welcome__stuff-item').removeClass('welcome__stuff-item--active');
		$(this).parent().addClass('welcome__stuff-item--active');
	});
	...
	$('.button-contacts--show').on('click', function() {
